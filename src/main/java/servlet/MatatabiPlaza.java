...
@WebServlet("/MatatabiPlaza")
public class MatatabiPlaza extends HttpServlet{
	String page_name = "matatabiPlaza";
	String bbs_type = "matatabi";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    if (text != null && text.length() != 0) {
			...
			postMutterLogic.execute(mutter, user_account, "matatabi");
	    } else {
