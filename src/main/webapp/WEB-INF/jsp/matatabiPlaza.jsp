...
<body>
	...
	<div class="flex-container">
		...
		<main>
			<form action="MatatabiPlaza" method="post">
				<p class="form-username"><%=loginUser.getUserid()%></p>
				<textarea id="textarea" name="text" maxlength="140" cols="60" rows="1" placeholder="ねこちゃんを助けてあげよう"></textarea>
